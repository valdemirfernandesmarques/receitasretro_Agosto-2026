...
<div class="container" style="padding: 40px 20px; max-width: 900px; margin: auto; line-height: 1.6;">
    <h1>Política de Privacidade</h1>
    <p>
        Na Receitasretro, privacidade e segurança são prioridades e nos comprometemos com a transparência do tratamento de dados pessoais dos nossos usuários/clientes. Por isso, esta presente Política de Privacidade estabelece como é feita a coleta, uso e transferência de informações de clientes ou outras pessoas que acessam ou usam nosso site.
    </p>
    <p>
    ...
    <p>
        Dessa forma, a Receitasretro, doravante denominada simplesmente como "Receitasretro", inscrita no CNPJ/MF sob o nº (nº do CNPJ), no papel de Controladora de Dados, obriga-se ao disposto na presente Política de Privacidade.
    </p>
    ...
    <p>
        É a partir do seu consentimento que tratamos os seus dados pessoais. O consentimento é a manifestação livre, informada e inequívoca pela qual você autoriza a Receitaretro a tratar seus dados.
    </p>
    <p>
    ...
    <p>
        O seu consentimento será obtido de forma específica para cada finalidade acima descrita, evidenciando o compromisso de transparência e boa-fé da Receitasretro para com seus usuários/clientes, seguindo as regulações legislativas pertinentes.
    </p>
    <p>
        Ao utilizar os serviços da Receitaretro e fornecer seus dados pessoais, você está ciente e consentindo com as disposições desta Política de Privacidade, além de conhecer seus direitos e como exercê-los.
    </p>
    <p>
    ...
    <p>
        A receitasretro assegura a seus usuários/clientes seus direitos de titular previstos no artigo 18 da Lei Geral de Proteção de Dados. Dessa forma, você pode, de maneira gratuita e a qualquer tempo:
    </p>
    <ul>
        ...
        <li>Solicitar a portabilidade de seus dados, através de um relatório de dados cadastrais que a Receitasretro trata a seu respeito.</li>
    ...
    <p>
        Para exercer seus direitos de titular, você deve entrar em contato com a Receitasretro através dos seguintes meios disponíveis:
    </p>
    <p>
        Meio de contato<br>
        Meio de contato
    ...
    <p>
        Seus dados pessoais coletados pela Receitasretro serão utilizados e armazenados durante o tempo necessário para a prestação do serviço ou para que as finalidades elencadas na presente Política de Privacidade sejam atingidas, considerando os direitos dos titulares dos dados e dos controladores.
    </p>
    <p>
        De modo geral, seus dados serão mantidos enquanto a relação contratual entre você e a Receitasretro perdurar. Findado o período de armazenamento dos dados pessoais, estes serão excluídos de nossas bases de dados ou anonimizados, ressalvadas as hipóteses legalmente previstas no artigo 16 lei geral de proteção de dados, a saber:
    </p>
    <ul>
    ...
    <p>
        O armazenamento de dados coletados pela Receitasretro reflete o nosso compromisso com a segurança e privacidade dos seus dados. Empregamos medidas e soluções técnicas de proteção aptas a garantir a confidencialidade, integridade e inviolabilidade dos seus dados. Além disso, também contamos com medidas de segurança apropriadas aos riscos e com controle de acesso às informações armazenadas.
    </p>
    ...
    <p>
        Tendo em vista a preservação de sua privacidade, a Receitasretro não compartilhará seus dados pessoais com nenhum terceiro não autorizado. 
    </p>
    <p>
        Seus dados poderão ser compartilhados com nossos parceiros comerciais: Receitasretro ou futuro parceiro comercial, inscrito no CPF/CNPJ sob o nº (número do CPF Ou CNPJ do parceiro comercial).
    </p>
    <p>
    ...
    <ul>
        ...
        <li>III - Proteção dos direitos da Receitasretro em qualquer tipo de conflito, inclusive os de teor judicial.</li>
    </ul>
    ...
    <p>
        Nesse sentido, a Receitasretro se compromete a sempre adotar eficientes padrões de segurança cibernética e de proteção de dados, nos melhores esforços de garantir e cumprir as exigências legislativas.
    </p>
    <p>
    ...
    <p>
        A Receitasretro faz uso de Cookies, que são arquivos de texto enviados pela plataforma ao seu computador e que nele se armazenam, que contém informações relacionadas à navegação do site. Em suma, os Cookies são utilizados para aprimorar a experiência de uso.
    </p>
    <p>
    ...
    <p>
        A Receitasretro utiliza os seguintes Cookies: (descrição dos tipos de Cookies utilizados pelo site).
    </p>
    <p>
    ...
    <p>
        A Receitasretro prevê a responsabilidade dos agentes que atuam nos processos de tratamento de dados, em conformidade com os artigos 42 ao 45 da Lei Geral de Proteção de Dados.
    </p>
    <p>
    ...
    <p>
        Caso a Autoridade Nacional de Proteção de Dados exija a adoção de providências em relação ao tratamento de dados realizado pela Receitasretro, comprometemo-nos a segui-las. 
    </p>

    <h3>10.1 Isenção de responsabilidade</h3>
    <p>
        Conforme mencionado no Tópico 6, embora adotemos elevados padrões de segurança a fim de evitar incidentes, não há nenhuma página virtual inteiramente livre de riscos. Nesse sentido, a Receitasretro não se responsabiliza por:
    </p>
    <ul>
        <li>I - Quaisquer consequências decorrentes da negligência, imprudência ou imperícia dos usuários em relação a seus dados individuais. Garantimos e nos responsabilizamos apenas pela segurança dos processos de tratamento de dados e do cumprimento das finalidades descritas no presente instrumento.</li>
    </ul>
    <p>
        Destacamos que a responsabilidade em relação à confidencialidade dos dados de acesso é do usuário.
    </p>
    <ul>
        <li>II - Ações maliciosas de terceiros, como ataques de hackers, exceto se comprovada conduta culposa ou deliberada da Receitasretro.</li>
    </ul>
    <p>
    ...
    <ul>
        <li>III - Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários para a utilização dos serviços da Receitasretro; quaisquer consequências decorrentes de informações falsas ou inseridas de má-fé são de inteiramente responsabilidade do usuário/cliente.</li>
    </ul>

    <h2>11. Encarregado de Proteção de Dados</h2>
    <p>
        A Receitasretro disponibiliza os seguintes meios para que você possa entrar em contato conosco para exercer seus direitos de titular: (meios de contato).
    </p>
    <p>
    ...
    <p>
        Valdemir Fernandes e Rinaldo Duarte.<br>
        Email: receitasretro.sabor@gmail.com
    </p>
</div>
